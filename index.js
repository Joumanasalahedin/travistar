...
function updateForecastDays() {
    ...
    for (let i = 1; i <= 5; i++) {
        ...
        let forecastDayElement = document.querySelector(
            `.week-forecast .col:nth-child(${i}) h3`
        );
        if (forecastDayElement) {
            forecastDayElement.innerHTML = days[dayIndex];
        }
    }
}
...
// Call updateForecastDays to update the 5-day forecast
updateForecastDays();
